	...
	<div class="col-md-9">
		...
		<form action="index.php?page=users&id=<?php echo $opened['id']; ?>" method="post" role="form">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="first_name" id="first_name" value="<?php echo $opened['first_name']; ?>" placeholder="First Name" autocomplete="off">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="last_name" id="last_name" value="<?php echo $opened['last_name']; ?>" placeholder="Last Name" autocomplete="off">
